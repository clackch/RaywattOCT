...
void CConfiguration::Initialize(tstring configFile)
{
	...
	this->laserModule.delayLineSMSteps = ::GetPrivateProfileInt(_T("LaserModule"), _T("DelayLineSMSteps"), 4, configFilePath.c_str());
	this->laserModule.delayLineSMSpeed = ::GetPrivateProfileInt(_T("LaserModule"), _T("DelayLineSMSpeed"), 8, configFilePath.c_str());
