    ...
    public partial class ReviewViewModel : ReviewViewModelBase
    {
        ...
        public override void OnNavigated(object sender, object navigatedEventArgs)
        {
            ...
            if (extraData != null)
            {
                ...
                LoadPatientCaseOrientationFromDB();
        ...
        private void LoadPatientCaseOrientationFromDB()
        {
            ...
            foreach (var caseItem in patientCases)
            {
                if (caseItem.Id == PatientCase.Id)
                {
                    PatientCase.LongitudeOrientation = caseItem.Isdistaltoproximal
                        ? LongitudeOrientation.DistalToProximal
                        : LongitudeOrientation.ProximalToDistal;
                    break;
                }
            }
        }
        ...
        private void AdjustIndicatorByOrientation()
        {
            ...
            if (PatientCase.LongitudeOrientationChanged)
            {
                ...
                else
                {
                    ...
                    int totalFrames = PatientCase.NumOfFrames;
                    var adjustedBookmarks = bookmarks!
                        .Select(bm => new Bookmark
                        {
                            FrameNumber = totalFrames - bm.FrameNumber - 1,
                            LongitudeX = Constants.LongitudeWidth - bm.LongitudeX - 1
                        })
                        .ToList();

                    PatientCase.Bookmark = JsonConvert.SerializeObject(adjustedBookmarks);
                }
            }
        }
