...
namespace RaywattApp.Views.Component
{
    public class IconRepeatButton : RepeatButton, SvgComponentBase
    {
        ...
        public static DependencyProperty IconProperty = DependencyProperty.Register("Icon", typeof(string), typeof(IconRepeatButton), new PropertyMetadata(null, SvgComponentBase.OnIconPropertyChanged));
